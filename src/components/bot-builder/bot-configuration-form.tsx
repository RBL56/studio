...
const botConfigurationSchema = z.object({
  ...
  ticks: z.coerce.number().int().min(1, 'Ticks must be at least 1.'),
  lastDigitPrediction: z.coerce.number().int().min(0).max(9),
  predictionType: z.enum(['matches', 'differs']),
  initialStake: z.coerce.number().min(1, 'Stake must be at least 1.'),
  takeProfit: z.coerce.number().optional(),
  stopLoss: z.coerce.number().optional(),
  useMartingale: z.boolean().default(false),
});

type BotConfigurationValues = z.infer<typeof botConfigurationSchema>;
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Set up your trading parameters.</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        <SelectItem value="volatility_100_index">Volatility 100 Index</SelectItem>
                        <SelectItem value="volatility_75_index">Volatility 75 Index</SelectItem>
                        <SelectItem value="boom_500_index">Boom 500 Index</SelectItem>
                        <SelectItem value="crash_500_index">Crash 500 Index</SelectItem>
                      </SelectContent>
                    </Select>
                    <FormMessage />
                  </FormItem>
